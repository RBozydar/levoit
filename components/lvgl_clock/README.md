...
[`example_flipclock.yaml`](./example_flipclock.yaml),
[`example_seg_matrix.yaml`](./example_seg_matrix.yaml) - plus the 12-hour /
no-seconds AM/PM variants
[`example_digital_12h.yaml`](./example_digital_12h.yaml) and
[`example_flipclock_12h.yaml`](./example_flipclock_12h.yaml), and
...
A full version is in [`example_analog.yaml`](./example_analog.yaml).
...
See [`example_digital_12h.yaml`](./example_digital_12h.yaml).
...
See [`example_flipclock_12h.yaml`](./example_flipclock_12h.yaml).
